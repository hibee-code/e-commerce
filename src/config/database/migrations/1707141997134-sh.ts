...
export class Sh1707141997134 implements MigrationInterface {
    name = 'Sh1707141997134'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."order_paymentstatus_enum" AS ENUM('paid', 'pending')`);
        await queryRunner.query(`CREATE TABLE "order" ("id" BIGSERIAL NOT NULL, "isPaid" boolean, "orderDate" date, "deliveryStatus" "public"."order_deliverystatus_enum" NOT NULL, "paymentStatus" "public"."order_paymentstatus_enum" NOT NULL, "cartId" bigint, CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "cart_details" ("id" BIGSERIAL NOT NULL, "cartId" bigint, "productId" bigint, "price" bigint, "createdAt" bigint, "item" bigint, "updateAt" bigint, CONSTRAINT "PK_6ac8b222cc04b34e7c14c1205cf" PRIMARY KEY ("id"))`);
