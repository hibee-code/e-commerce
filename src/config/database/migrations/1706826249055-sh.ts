...
export class Sh1706826249055 implements MigrationInterface {
  name = 'Sh1706826249055';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "profile_collection" ("id" BIGSERIAL NOT NULL, "profileType" "public"."profile_collection_profiletype_enum" NOT NULL, "isAdmin" boolean NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "profileTypeId" bigint NOT NULL, "userId" bigint NOT NULL, CONSTRAINT "PK_e5d01864c4c3af52721b886fe83" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "product" ("id" BIGSERIAL NOT NULL, "name" character varying, "description" character varying, "brand" character varying, "price" integer, "tag" integer, "quantity" integer, "rating" integer, "productCategory" "public"."product_productcategory_enum" NOT NULL, CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "cart" ("id" BIGSERIAL NOT NULL, "description" character varying, "price" bigint, "quantity" bigint, "totalItem" bigint, "userId" bigint, "image" character varying NOT NULL, CONSTRAINT "PK_c524ec48751b9b5bcfbf6e59be7" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "entity_user_profile" ADD CONSTRAINT "FK_19b2f4ff2abd89dbe2b89cf8162" FOREIGN KEY ("entityProfileId") REFERENCES "entity_profile"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "entity_user_profile" DROP CONSTRAINT "FK_19b2f4ff2abd89dbe2b89cf8162"`,
    );
