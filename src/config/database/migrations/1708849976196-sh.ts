...
export class Sh1708849976196 implements MigrationInterface {
    name = 'Sh1708849976196'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "product_details" ("id" bigint NOT NULL, "specification" character varying, "colour" character varying, "size" bigint, "weight" bigint, CONSTRAINT "PK_a3fa8e2e94f3c37a8d731451de4" PRIMARY KEY ("id"))`);
